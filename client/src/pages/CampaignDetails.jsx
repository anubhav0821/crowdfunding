        ...
        <div className='flex-[2] flex flex-col gap-[40px]'>
            ...
            <div className='mt-[20px] flex flex-row items-center flex-wrap gap-[14px]'>
              ...
              <div>
                ...
                <p className='mt-[4px] font-epilogue font-normal text-[12px] text-[#808191]'>5 Campaigns</p>
              </div>
              </div>
            </div>
            <div>
        ...
        <h4 className='font-epilogue font-semibold text-[18px] text-white '>FUND</h4>
            <div className='mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]'>
                  ...
                  <div className='mt-[30px]'>
                      ...
                      border-[1px] border-[#3a3a43] bg-transparent font-epilogue text-white text-[18px] leading-[30px]
                      placeholder:text-[#4b5264] rounded-[10px]'
                      value={amount}
                      onChange={(e) => setAmount(e.target.value)} />
                    <div className='my-[20px] p-4 bg-[#13131a] rounded-[10px]'>
                      <h4 className='font-epilogue font-semibold text-[14px] leading-[22px] text-white'>Back it because you believe in it</h4>
                      <p className='mt-[20px] font-epilogue font-normal leading-[22px] text-[#808191]'>Support the project for no reward, just because it speakes to you.</p>
                    </div>
